...
const Navbar = () => {
  ...
  return (
    <>
      {/* Main Navbar */}
      <nav className="fixed top-0 left-0 w-full h-20 bg-black text-white flex items-center justify-between px-6 md:px-12 z-[100] border-b border-white/10">
          ...
          {navLinks.map((link) => (
            <li key={link.name}>
              <a 
                ...
                className="text-[11px] uppercase tracking-[0.2em] font-bold hover:text-[#E2B13C] transition-colors"
              >
                {link.name}
              </a>
            </li>
