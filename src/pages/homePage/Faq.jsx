    ...
    return (
      <div className="w-full py-24 px-6 md:px-10 bg-zinc-950 font-sans">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Added ref to this container for GSAP targeting */}
          <div ref={containerRef} className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="faq-item group border border-white/10 rounded-xl bg-white/5 overflow-hidden transition-colors hover:border-[#E2B13C]/30"
              >
                <button
