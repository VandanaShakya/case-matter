...
const Construction = () => {
  ...
  return (
   ...
   <section ref={container} className="relative min-h-screen w-full overflow-hidden bg-zinc-950 font-sans flex items-center pt-20">
      {/* 1. Fully Responsive Background Image - Themed for Infrastructure */}
      <img
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          <div ref={carpetRef} className="overflow-hidden">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter text-white leading-tight">
              Construction & <br />
              <span className="text-[#E2B13C]">Infrastructure Disputes.</span>
            </h1>
          </div>
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-base md:text-lg text-zinc-400 max-w-xl border-l-2 border-[#E2B13C]/50 pl-6 italic">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <motion.button 
                whileHover={{ scale: 1.05, backgroundColor: "#f5c451" }}
                whileTap={{ scale: 0.95 }}
                className="rounded-full bg-[#E2B13C] px-10 py-4 font-bold text-zinc-950 shadow-[0_0_20px_rgba(226,177,60,0.3)] transition-all"
              >
                Resolve Your Matter
              </motion.button>
        ...
        {/* RIGHT BLOCK: High-Value Exposure Stats */}
        <motion.div 
        ...
        >
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/5 backdrop-blur-xl p-10 shadow-2xl">
            <h3 className="text-[#E2B13C] text-sm font-bold uppercase tracking-widest mb-6">Critical Risk Factors</h3>
            ...
            <div className="absolute -z-10 -bottom-10 -left-10 w-64 h-64 bg-[#E2B13C]/10 blur-[100px] rounded-full" />
          </div>
        </motion.div>
      </div>

      {/* 4. Background Jurisprudential Quote */}
    ...
    <section ref={container} className="bg-zinc-950 py-24 px-6 md:px-20 lg:px-32 flex flex-col items-start justify-center min-h-[60vh]">
      <div className="max-w-5xl w-full">
        
        {/* Animated Heading */}
        <div ref={headingRef} className="mb-8">
         
          <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tighter leading-tight">
            Construction and <br /> 
            Infrastructure Disputes
          </h1>
        </div>

        {/* Single Paragraph Content Block */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, ease: "easeOut" }}
          viewport={{ once: true }}
          className="w-full relative group p-8 md:p-8 border border-white/10 bg-white/5 backdrop-blur-xl"
        >
          {/* Subtle accent line that glows on hover */}
          <div className="absolute left-0 top-1/4 h-1/2 w-[2px] bg-[#E2B13C] transition-all duration-500 group-hover:h-full group-hover:top-0" />
          ...
          <p className="text-zinc-300 text-lg md:text-xl leading-relaxed font-light text-left">
            ...
            through a <span className="text-[#E2B13C] font-medium">documentation-driven and evidence-focused approach</span>, 
            ...
            of awards—with a steadfast commitment to achieving <span className="text-white border-b border-[#E2B13C]/50">commercially viable resolutions</span> that 
            safeguard our clients' contractual rights and long-term project interests.
          </p>

          {/* Interactive Footer element for the block */}
          <div className="mt-8 flex items-center gap-4">
             <motion.div 
               whileHover={{ scale: 1.1 }}
               className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center text-[#E2B13C]"
             >
