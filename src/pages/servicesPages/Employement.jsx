...
const Employement = () => {
  ...
  {/* 1. Fully Responsive Background Image - Updated to a professional office environment */}
  <img
  ...
  <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20">
    ...
    <div className="space-y-8">
      <div ref={carpetRef} className="overflow-hidden">
        <p className="text-[#E2B13C] font-bold tracking-[0.2em] uppercase mb-4 text-sm md:text-base">
          Employment Law
        </p>
      ...
      >
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="rounded-full bg-[#E2B13C] px-8 md:px-10 py-4 font-bold text-zinc-950 shadow-[0_0_20px_rgba(226,177,60,0.3)] transition-all text-sm md:text-base"
          >
            Workforce Solutions
          </motion.button>
    ...
    >
      <div className="relative overflow-hidden rounded-[2rem] border border-white/10 aspect-[4/5] shadow-2xl">
        <motion.img 
          ...
          src="https://images.unsplash.com/photo-1521791136364-798e730bb36d?q=80&w=800&auto=format&fit=crop" 
        ...
        >
          <p className="text-[#E2B13C] text-sm font-bold uppercase tracking-widest">Compliance First</p>
      ...
      <div className="absolute -z-10 -top-10 -right-10 w-72 h-72 bg-[#E2B13C]/10 blur-[120px] rounded-full" />
    </motion.div>
  </div>

  {/* 4. Fixed Quote Background - Updated to Employment context */}
