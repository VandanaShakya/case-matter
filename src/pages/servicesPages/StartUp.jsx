  ...
  <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center py-12">
    ...
    <div className="space-y-8">
      <div ref={carpetRef} className="overflow-hidden">
        <p className="text-[#E2B13C] font-bold tracking-[0.2em] uppercase mb-3 text-xs md:text-sm">
          Venture Support
        </p>
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white leading-[1.1]">
          Startup Law <br />
          <span className="text-[#E2B13C]">& Compliance.</span>
        </h1>
      </div>
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-base text-zinc-400 max-w-lg leading-relaxed border-l-2 border-[#E2B13C]/30 pl-5 italic">
        ...
        <div className="flex flex-wrap gap-4 pt-2">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="rounded-full bg-[#E2B13C] px-8 py-4 text-sm font-bold text-zinc-950 shadow-[0_10px_20px_rgba(226,177,60,0.2)] transition-all"
          >
            Launch Securely
          </motion.button>
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl group hover:border-white/20 transition-all">
        <h3 className="text-[#E2B13C] text-xs font-black uppercase tracking-[0.2em] mb-3">
      ...
      {/* Card 2 */}
      <div className="relative overflow-hidden rounded-2xl border border-[#E2B13C]/20 bg-zinc-900/40 p-8 group hover:bg-zinc-900/60 transition-all">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#E2B13C]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
      </div>

      {/* Background Glow Ornament */}
      <div className="absolute -z-10 -bottom-20 -right-10 w-64 h-64 bg-[#E2B13C]/10 blur-[100px] rounded-full" />
    </motion.div>
  </div>

  {/* 4. Background Quote - Updated to a relevant latin legal maxim */}
