  ...
  <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
    ...
    <div className="space-y-6">
      ...
      <div ref={carpetRef} className="overflow-hidden">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
          Contract & Claims <br />
          <span className="text-[#E2B13C]">Management</span>
        </h1>
      </div>
      ...
      >
        ...
        <p className="text-sm md:text-base text-zinc-400 max-w-xl border-l-2 border-[#E2B13C]/50 pl-5 italic">
        ...
        <div className="flex flex-wrap gap-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="rounded-full bg-[#E2B13C] px-8 py-3 font-semibold text-zinc-950 shadow-lg transition"
          >
            Claims Advisory
          </motion.button>
    ...
    >
      <div className="relative overflow-hidden rounded-[2rem] border border-white/10 aspect-[4/5] shadow-2xl">
        ...
        >
          <p className="text-[#E2B13C] text-sm font-bold uppercase tracking-widest">
            Strategic Support
          </p>
          <p className="text-white text-lg mt-1 font-medium">
            Precise documentation and structured claims strengthen legal outcomes.
          </p>
        </motion.div>
