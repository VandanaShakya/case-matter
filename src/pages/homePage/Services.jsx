    ...
    <section id="services" ref={containerRef} className="bg-zinc-950 py-32 px-6 md:px-20 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-24 space-y-4">
          <h2 className="text-[#E2B13C] uppercase tracking-[0.3em] text-sm font-bold">
            Our Services
          </h2>
        ...
        <div ref={stackRef} className="relative space-y-10 pb-32">
          {services.map((service, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-900/80 p-8 md:p-12 backdrop-blur-2xl transition-all duration-500 group-hover:border-[#E2B13C]/50 group-hover:bg-zinc-800/90 shadow-2xl">
                
                {/* Visual Accent */}
                <div className="absolute top-0 left-0 w-2 h-full bg-[#E2B13C] scale-y-0 group-hover:scale-y-100 transition-transform duration-500 origin-top" />
                
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                  <div className="flex-1 space-y-4">
                    <span className="text-[#E2B13C] font-mono text-lg">0{index + 1}</span>
                    <h3 className="text-2xl md:text-4xl font-bold text-white group-hover:text-[#E2B13C] transition-colors">
                      {service.title}
                    </h3>
                  ...
                  {/* Circular Button Style Icon */}
                  <div className="h-16 w-16 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-[#E2B13C] group-hover:border-[#E2B13C] transition-all duration-500">
                    <svg 
